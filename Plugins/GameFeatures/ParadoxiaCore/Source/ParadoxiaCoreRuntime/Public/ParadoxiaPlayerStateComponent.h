...
class PARADOXIACORERUNTIME_API UParadoxiaPlayerStateComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	UParadoxiaPlayerStateComponent();
	...
	FString TestEmail = "test@test.com";
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Setup, meta = (EditCondition = "bAttemptPersistence"))
	...
	void LoginAndCreateSessionServer(FString Email, FString Password);
